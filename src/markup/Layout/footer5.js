                            ...
                            <div className="row">
                                ...
                                <div className="col-5 col-lg-2 col-md-6 col-sm-6 footer-col-4">
                                    <div className="widget widget_services border-0">
                                        ...
                                        <ul>
                                            ...
                                            <li><Link to={"#"}>Ürünlerimiz</Link></li>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 footer-col-4">
                                    <div className="widget widget_getintuch">
                                        ...
                                        <ul>
                                            <li><i className="ti-mobile"></i><strong>Telefon</strong> 0(532)667 94 63</li>
                                            <li><i className="ti-email"></i><strong>email</strong>windsigorta@outlook.com</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 footer-col-4 ">
                                    <div className="widget">
                                        ...
                                        <p className="text-capitalize m-b20">Yeni ürünlerimiz ve size özel kampanyalarımızdan haberdar olmak isterseniz gündemimize kayıt olabilirsiniz.</p>
                                        <div className="subscribe-form m-b20">
                                            <form className="dzSubscribe" action="script/mailchamp.php" method="post">
                                                <div className="dzSubscribeMsg"></div>
                                                <div className="input-group">
                                                    <input name="dzEmail" required="required" className="form-control" placeholder="E-mail" type="email" />
                                                    <span className="input-group-btn">
                                                        <button name="submit" value="Submit" type="submit" className="site-button">Kaydet</button>
                                                    </span>
                                                </div>
                                            </form>
                                        </div>
