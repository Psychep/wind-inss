...
import kasko from "../../../images/background/dolu-sigortasi.png";
      ...
      <>
        ...
        <div className="page-content bg-white rubik-font">
          ...
          >
            <PageTitle
              style="color: #333;"
              motherMenu={flipItem[10].name}
              activeMenu={flipItem[10].urun[2].urun}
            />
          </div>
              ...
              <div className="container">
                <div className="row m-b40">
                  <div className="col-lg-6 col-md-6 m-b20">
                    <h2 className="m-b10 m-t0">{flipItem[10].name}</h2>
                    <p className="m-b10">{flipItem[10].aciklama}</p>
                  </div>
                ...
                <div className="row m-b50">
                  <div className="col-md-6 m-b20">
                    <div className="p-a30 bg-gray">
                      <h6>
                        Ürün: {flipItem[10].urun[2].urun} <br />
                        Açıklama:
                        <span className="m-l10 font-weight-300 text-gray-dark">
                          {flipItem[10].urun[2].aciklama}
                        </span>
                      </h6>
                      <h6>Sigorta şirketi: </h6>
                    </div>
                  </div>
                  <div className="col-md-6 align-self-center">
                    ...
                    <p className="m-b0">
                      <a href={flipItem[10].urun[1].link}>
                        {flipItem[10].urun[1].urun}
                      </a>
                    </p>
                    <p className="m-b0">
                      <a href={flipItem[10].urun[0].link}>
                        {flipItem[10].urun[0].urun}
                      </a>
                    </p>

                    <p className="m-b0">
                      <a href={flipItem[10].urun[2].link}>
                        {flipItem[10].urun[2].urun}
                      </a>
                    </p>
                    <p className="m-b0">
                      <a href={flipItem[10].urun[3].link}>
                        {flipItem[10].urun[3].urun}
                      </a>
                    </p>
                  </div>
                </div>
        ...
        >
          <FormStyle
            category={flipItem[10].name}
            produtc={flipItem[10].urun[2].urun}
          />
        </div>
        <Footer />
      </>
