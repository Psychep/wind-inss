...
import kasko from "../../../images/background/emita-sigortasi.png";
  ...
  render() {
    return (
      <>
        ...
        <div className="page-content bg-white rubik-font">
          ...
          >
            <PageTitle
              ...
              activeMenu={flipItem[2].urun[2].urun}
            />
          </div>
              ...
              <div className="container">
                <div className="row m-b40">
                  <div className="col-lg-6 col-md-6 m-b20">
                    <h2 className="m-b10 m-t0">{flipItem[2].name}</h2>
                    <p className="m-b10">{flipItem[2].aciklama}</p>
                  </div>
                ...
                <div className="row m-b50">
                  <div className="col-md-6 m-b20">
                    <div className="p-a30 bg-gray">
                      <h6>
                        Ürün: {flipItem[2].urun[2].urun} <br />
                        Açıklama:
                        <span className="m-l10 font-weight-300 text-gray-dark">
                          {flipItem[2].urun[2].aciklama}
                        </span>
                      </h6>
                      <h6></h6>
                    </div>
                  ...
                  <div className="col-md-6 align-self-center">
                    <h5 className="text-black fw5 m-b10">{flipItem[2].name}</h5>
                    <p className="m-b0">
                      <a href={flipItem[2].urun[0].link}>
                        {flipItem[2].urun[0].urun}
                      </a>
                    </p>
                    <p className="m-b0">
                      <a href={flipItem[2].urun[1].link}>
                        {flipItem[2].urun[1].urun}
                      </a>
                    </p>
                    <p className="m-b0">
                      <a href={flipItem[2].urun[2].link}>
                        {flipItem[2].urun[2].urun}
                      </a>
                    </p>
                  </div>
                </div>
        ...
        >
          <FormStyle
            category={flipItem[2].name}
            produtc={flipItem[2].urun[2].urun}
          />
        </div>
        <Footer />
      </>
