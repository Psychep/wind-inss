...
import kasko from "../../../images/background/sera-sigortasi.png";
      ...
      <>
        ...
        <div className="page-content bg-white rubik-font">
          ...
          >
            <PageTitle
              ...
              activeMenu={flipItem[10].urun[3].urun}
            />
          </div>
                ...
                <div className="row m-b50">
                  <div className="col-md-6 m-b20">
                    <div className="p-a30 bg-gray">
                      <h6>
                        Ürün: {flipItem[10].urun[3].urun} <br />
                        Açıklama:
        ...
        >
          <FormStyle
            ...
            produtc={flipItem[10].urun[3].urun}
          />
        </div>
        <Footer />
      </>
