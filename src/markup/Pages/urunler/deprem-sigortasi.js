      ...
      <>
        ...
        <div className="page-content bg-white rubik-font">
          ...
          >
            <PageTitle
              style="color: #333;"
              motherMenu={flipItem[8].name}
              activeMenu={flipItem[8].urun[0].urun}
            />
          </div>
              ...
              <div className="container">
                <div className="row m-b40">
                  <div className="col-lg-6 col-md-6 m-b20">
                    <h2 className="m-b10 m-t0">{flipItem[8].name}</h2>
                ...
                <div className="row m-b50">
                  <div className="col-md-6 m-b20">
                    <div className="p-a30 bg-gray">
                      <h6>
                        Ürün: {flipItem[8].urun[0].urun} <br />
                        Açıklama:
                        <span className="m-l10 font-weight-300 text-gray-dark">
                          {flipItem[8].urun[0].aciklama}
                        </span>
                      </h6>
                      <h6></h6>
                    </div>
                  ...
                  <div className="col-md-6 align-self-center">
                    <h5 className="text-black fw5 m-b10">{flipItem[8].name}</h5>
                    <p className="m-b0">
                      <a href={flipItem[8].urun[0].link}>
        ...
        >
          <FormStyle
            category={flipItem[8].name}
            produtc={flipItem[8].urun[0].urun}
          />
        </div>
        <Footer />
      </>
