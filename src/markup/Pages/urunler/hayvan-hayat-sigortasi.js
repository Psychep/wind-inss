...
import kasko from "../../../images/background/hayvan-hayat-sigortasi.png";
      ...
      <>
        ...
        <div className="page-content bg-white rubik-font">
          ...
          >
            <PageTitle
              ...
              activeMenu={flipItem[10].urun[0].urun}
            />
          </div>
                ...
                <div className="row m-b50">
                  <div className="col-md-6 m-b20">
                    <div className="p-a30 bg-gray">
                      <h6>
                        Ürün: {flipItem[10].urun[0].urun} <br />
                        Açıklama:
                        <span className="m-l10 font-weight-300 text-gray-dark">
                          {flipItem[10].urun[0].aciklama}
                        </span>
                      </h6>
                      <h6></h6>
                    </div>
        ...
        >
          <FormStyle
            ...
            produtc={flipItem[10].urun[0].urun}
          />
        </div>
        <Footer />
      </>
