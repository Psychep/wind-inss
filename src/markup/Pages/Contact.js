                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    <div className="input-group">
                                                        ...
                                                        <input name="dzOther[Phone]" type="text" required className="form-control" placeholder="Telefon Numarası" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-12">
                                                <div className="form-group">
                                                    <div className="input-group">
                                                        ...
                                                        <textarea name="dzMessage" rows="4" className="form-control" required placeholder="Mesajınız"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-12">
