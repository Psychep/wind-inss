                ...
                <div className="row">
                  ...
                  <div className="col-lg-12">
                    <div className="time-line clearfix">
                      <BlogLeft
                        title="Sigorta İhtiyacınızı Belirleyin"
                        parg="Wind Sigorta'nın sunduğu trafik ve kasko gibi araç sigortasından, ev sigortası ve sağlık sigortasına kadar uzanan yelpazedeki sigorta çeşitlerini inceleyin"
                        number="1"
                      />
                      <BlogRight
                        title="Karşılaştırmalı Teklif Alın"
                        parg="Sigortalarımız için kısa bir form doldurarak tüm ürünlerimiz için karşılaştırmalı teklif alın."
                        number="2"
                      />
                      <BlogLeft
                        title="Fırsatlarımızdan & Kampanyalarımızdan faydalanın"
                        parg="Wind Sigorta Size en uygun teklifleri verebilmek için size uygun kampanyaları sunar."
                        number="3"
                      />
                      <BlogRight
                        title="Hemen Şimdi Hızlı bir teklif Alın"
                        parg="Teklif Formunu doldurun ve size en kısa sürede tekliflerimizi sunalım."
                        number="4"
                      />
                    </div>
                  </div>
